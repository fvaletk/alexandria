...
RSpec.describe 'Publishers', type: :request do
  ...
  describe 'GET /api/publishers' do
    ...
    describe 'field picking' do
      context 'with the fields parameter' do
        ...
        it 'get publishers with only the id and name' do
  ...
  describe 'GET /api/publishers/:id' do
    context 'with existing resource' do
      ...
      it 'receives the "oreilly" publisher as JSON' do
        expected = { data: PublisherPresenter.new(oreilly, {}).fields.embeds }
        expect(response.body).to eq(expected.to_json)
      end
    end

    context 'with nonexistent resources' do
      it 'gets HTTP status 404' do
        get '/api/publishers/2314342'
  ...
  describe 'PATCH /api/publishers/:id' do
    ...
    context 'with valid parameters' do
      let(:params) {{name: 'oreilly2'}}

      it 'get HTTP status 200' do
        expect(response.status).to eq 200
      end
      ...
      it 'updates the record in the database' do
        expect(Publisher.first.name).to eq('oreilly2')
      end
    end
